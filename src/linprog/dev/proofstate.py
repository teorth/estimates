...
## Proof states describe the current state of a proof (a list of hypotheses and a goal).  The hypothesis is a list of objects; the goals are stored for now as strings, later as sympy basic classes.

class ProofState:
    def __init__(self, goal: str, hypotheses: list[object] = None):
        """
